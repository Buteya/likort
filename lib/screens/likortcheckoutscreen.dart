...
class _LikortCheckoutScreenState extends State<LikortCheckoutScreen> {
  ...
  Future<Map<String, dynamic>> getMpesaAccessToken() async {
    ...
    try {
      final http.Response response =
          await http.get(Uri.parse(tokenUrl), headers: headers);
  ...
  Future<void> fetchAccessToken(BuildContext context) async {
    const String consumerKey =
        'L5dKdxWq9SemWTAkaiXm1V06GlOSnpbQytwiqjsrMO5gxT8q'; // Replace with your consumer key
    const String consumerSecret =
        'PvoM5NeFGbQTrQvTevun19AVAC3LGFxCD05m1jhnMWBVkFBeTWpB5pr9A2NCHPdn'; // Replace with your consumer secret
  ...
  void _makePayment() async {
    ...
    var user = Provider.of<userLikort.User>(context, listen: false);
