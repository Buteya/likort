            ...
            drawer: Drawer(
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    leading:
                        const Icon(Icons.home_rounded), // Create Product icon
                                  ...
                                  children: [
                                     Consumer<Store>(
                                        ...
                                        return snapshot.data!['products'] == null
                                          ...
                                          future: getProductData(userId),
                                              builder: (BuildContext context, AsyncSnapshot<Map<String,dynamic>?> snapshotProduct) {
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: Image.network(
                                                                ...
                                                                fit: BoxFit.cover,
                                                                  snapshot.data!['products'][index]['imageUrls'][0]
                                                                  ),
                                                            ),
                                                          ),
                                                          Padding(
